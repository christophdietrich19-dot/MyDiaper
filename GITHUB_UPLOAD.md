...
Der Ordner `Diaper-GitHub` ist die bereinigte, hochladbare Projektkopie. Er enthält den reproduzierbaren Quellstand der Testversion 1.1.2.
...
Die Root-`index.html` bleibt auch ohne Build direkt als Testversion nutzbar.
