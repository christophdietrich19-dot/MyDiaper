(function(root){
  ...
  app.legacyDefaults = {
    ...
    settings:{location:'Hoyerswerda',locationMode:'manual',reminders:{stock:true,size:true,offers:true,market:true},preferredStores:['dm','Rossmann','Kaufland']},
    market:[
      ...
      {id:'m2',mode:'Tauschen',title:'Babylove Premium Größe 4',condition:'Geöffnet · ca. 28 Stück',count:28,price:'gegen Größe 5',distance:'4 km',owner:'Chris',created:'Heute'},
